...
realsurvey=RealNameSurvey('你的籍贯地在哪儿？')
realsurvey.show_question()
while True:
    new_response = input('请回答问卷问题，按 q 键退出：')
    if new_response == 'q':
        break
    name=input('请输入回答者姓名：')
    realsurvey.store_response(name,new_response)


for i in realsurvey.response:
    print(i+":"+realsurvey.response[i])




# survey = Survey('你喜欢的美食是什么？')
#
